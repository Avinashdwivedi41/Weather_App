...
function switchTab(clickedTab) {
    ...
    if (currentTab != clickedTab) {
        ...
        // Your Weather
            ...
            userInfoContainer.classList.remove("active");
            //ab main weather tab me aa gya hoon to weather bhi display krna padega so lets chek 
            // local storage first for coordinates if we saved them there.
            getFromSessionStorage();
        }
    }
}
...
function renderWeatherInfo(weatherInfo) {
    ...
    // fetching data and adding on UI
